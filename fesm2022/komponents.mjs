...
class AutocompleteComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.5", type: AutocompleteComponent, isStandalone: true, selector: "k-autocomplete", inputs: { inputElement: { classPropertyName: "inputElement", publicName: "inputElement", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: "@if (opened()) {\n    <div class=\"autocomplete-list\">\n        <ng-content />\n    </div>\n}\n", styles: [":host{display:block;width:100%;position:relative}div.autocomplete-list{display:flex;pointer-events:all;gap:8px;flex-direction:column;align-items:stretch;max-height:240px;overflow-y:scroll;background:var(--color-bg-transparent, rgba(33, 33, 33, .9411764706));z-index:2;position:absolute;top:100%;left:0;width:calc(100% - 32px);margin:8px;padding:8px;box-sizing:border-box}\n"] });
}
